...
action("corre este repo", "PROJECT_RUN", null, "SELECTED_REPOSITORY");
action("ejecuta este repo", "PROJECT_RUN", null, "SELECTED_REPOSITORY");
action("run this repo", "PROJECT_RUN", null, "SELECTED_REPOSITORY");
action("para este repo", "PROJECT_STOP", null, "SELECTED_REPOSITORY");
action("stop this repo", "PROJECT_STOP", null, "SELECTED_REPOSITORY");
